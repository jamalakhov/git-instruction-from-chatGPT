...
6. 
Если вы хотите обновить подмодуль до последней версии, перейдите в директорию подмодуля и выполните команду `git pull`.

Если вы хотите обновить все подмодули в вашем репозитории, выполните команду `git submodule update --recursive`.

Если вы хотите удалить подмодуль из вашего репозитория, выполните команду `git submodule deinit имя_подмодуля`, затем удалите директорию подмодуля вручную и удалите соответствующую строку в файле *.gitmodules*.
